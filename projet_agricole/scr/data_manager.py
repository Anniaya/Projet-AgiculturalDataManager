...
class AgriculturalDataManager:
    ...
    def load_data(self):
        ...
        self.monitoring_data = pd.read_csv(r'../../data/monitoring_cultures (1).csv', 
                                         parse_dates=['date'])
        ...
        self.soil_data = pd.read_csv(r'../../data/sols (1).csv')
        
        # Chargement de l'historique des rendements
        self.yield_history = pd.read_csv(r'../../data/historique_rendements (1).csv', 
                                       parse_dates=['date'])
